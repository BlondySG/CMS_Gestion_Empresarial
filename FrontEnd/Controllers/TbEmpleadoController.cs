...
namespace FrontEnd.Controllers
{
    ...
    public class TbEmpleadoController : Controller
    {
        ...
        private TbRolViewModel GetRol(int id)
        {
            try
            {
                TbRolViewModel rolViewModel = _rolHelper.Details(id);
        ...
        {
            List<TbRolViewModel> roles = _rolHelper.GetAll();
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                {
                    item.TbRol = _rolHelper.Details(item.IdRol);
                }
